...
const CURRENT_FLOW_OVERRIDES: Record<string, FlowDefinition> = {
  ...
  s13: {
    nodes: [
      { id: "start", label: "User Goal", type: "start", x: COL_CENTER, y: 30 },
      { id: "build", label: "Build Graph\n(executors + edges)", type: "process", x: COL_CENTER, y: 120 },
      { id: "topo", label: "Topological\nSort", type: "process", x: COL_CENTER, y: 210 },
      { id: "superstep", label: "Superstep\nReady?", type: "decision", x: COL_CENTER, y: 300 },
      { id: "parallel", label: "Run Executors\n(parallel)", type: "subprocess", x: COL_LEFT, y: 410 },
      { id: "wait", label: "Wait All\nComplete", type: "process", x: COL_LEFT, y: 500 },
      { id: "route", label: "Conditional\nRoute?", type: "decision", x: COL_RIGHT, y: 410 },
      { id: "next", label: "Next\nSuperstep", type: "process", x: COL_CENTER, y: 590 },
      { id: "end", label: "Workflow\nComplete", type: "end", x: COL_CENTER, y: 680 },
    ],
    edges: [
      { from: "start", to: "build" },
      { from: "build", to: "topo" },
      { from: "topo", to: "superstep" },
      { from: "superstep", to: "parallel", label: "ready" },
      { from: "superstep", to: "end", label: "done" },
      { from: "parallel", to: "wait" },
      { from: "wait", to: "route" },
      { from: "route", to: "next", label: "continue" },
      { from: "route", to: "end", label: "terminal" },
      { from: "next", to: "superstep" },
    ],
  },
  s14: {
    nodes: [
      { id: "start", label: "Tool Call", type: "start", x: COL_CENTER, y: 30 },
      { id: "bg_check", label: "Background\nFlag?", type: "decision", x: COL_CENTER, y: 130 },
      { id: "fg", label: "Run\nForeground", type: "subprocess", x: COL_RIGHT, y: 250 },
      { id: "thread", label: "Spawn\nThread", type: "subprocess", x: COL_LEFT, y: 250 },
      { id: "placeholder", label: "Return\nPlaceholder", type: "process", x: COL_LEFT, y: 350 },
      { id: "queue", label: "Notification\nQueue", type: "process", x: 60, y: 450 },
      { id: "drain", label: "Drain Before\nNext LLM Call", type: "process", x: COL_CENTER, y: 540 },
      { id: "inject", label: "Inject Results\nas Messages", type: "process", x: COL_CENTER, y: 630 },
      { id: "append", label: "Append\nResult", type: "process", x: COL_CENTER, y: 720 },
    ],
    edges: [
      { from: "start", to: "bg_check" },
      { from: "bg_check", to: "fg", label: "no" },
      { from: "bg_check", to: "thread", label: "yes" },
      { from: "fg", to: "append" },
      { from: "thread", to: "placeholder" },
      { from: "placeholder", to: "append" },
      { from: "thread", to: "queue", label: "done" },
      { from: "queue", to: "drain" },
      { from: "drain", to: "inject" },
      { from: "inject", to: "append" },
    ],
  },
  s17: {
    nodes: [
      { id: "start", label: "User Input", type: "start", x: COL_CENTER, y: 30 },
      { id: "llm", label: "LLM Call", type: "process", x: COL_CENTER, y: 120 },
      { id: "connect", label: "connect_mcp?", type: "decision", x: COL_CENTER, y: 210 },
      { id: "client", label: "Create MCP\nClient", type: "subprocess", x: COL_LEFT, y: 320 },
      { id: "discover", label: "Discover\nTools", type: "subprocess", x: COL_LEFT, y: 420 },
      { id: "namespace", label: "Namespace:\nmcp__server__tool", type: "process", x: COL_LEFT, y: 520 },
      { id: "pool", label: "Merge Into\nTool Pool", type: "process", x: COL_CENTER, y: 610 },
      { id: "call", label: "MCP Tool\nCall", type: "subprocess", x: COL_RIGHT, y: 320 },
      { id: "server", label: "External\nServer", type: "process", x: COL_RIGHT, y: 420 },
      { id: "append", label: "Append Result", type: "process", x: COL_CENTER, y: 700 },
      { id: "end", label: "Output", type: "end", x: COL_RIGHT, y: 210 },
    ],
    edges: [
      { from: "start", to: "llm" },
      { from: "llm", to: "connect" },
      ...
      { from: "connect", to: "end", label: "done" },
      { from: "client", to: "discover" },
      { from: "discover", to: "namespace" },
      { from: "namespace", to: "pool" },
      { from: "pool", to: "llm" },
      { from: "call", to: "server" },
      { from: "server", to: "append" },
      { from: "append", to: "llm" },
  ...
  s18: {
    nodes: [
      { id: "start", label: "Question +\nAnswer", type: "start", x: COL_CENTER, y: 30 },
      { id: "dispatch", label: "Dispatch to\nEvaluators", type: "process", x: COL_CENTER, y: 130 },
      { id: "coherence", label: "Coherence\nEvaluator", type: "subprocess", x: COL_LEFT, y: 250 },
      { id: "relevance", label: "Relevance\nEvaluator", type: "subprocess", x: COL_RIGHT, y: 250 },
      { id: "scores", label: "Collect\nScores", type: "process", x: COL_CENTER, y: 370 },
      { id: "composite", label: "Composite\nEvaluator", type: "process", x: COL_CENTER, y: 470 },
      { id: "threshold", label: "Above\nThreshold?", type: "decision", x: COL_CENTER, y: 570 },
      { id: "pass", label: "Record\nPass", type: "end", x: COL_LEFT, y: 670 },
      { id: "fail", label: "Record\nFail", type: "end", x: COL_RIGHT, y: 670 },
    ],
    edges: [
      { from: "start", to: "dispatch" },
      { from: "dispatch", to: "coherence" },
      { from: "dispatch", to: "relevance" },
      { from: "coherence", to: "scores" },
      { from: "relevance", to: "scores" },
      { from: "scores", to: "composite" },
      { from: "composite", to: "threshold" },
      { from: "threshold", to: "pass", label: "yes" },
      { from: "threshold", to: "fail", label: "no" },
    ],
  },
  s19: {
    nodes: [
      { id: "start", label: "App Start", type: "start", x: COL_CENTER, y: 30 },
      { id: "di", label: "AddAIAgent()\nRegister Services", type: "process", x: COL_CENTER, y: 130 },
      { id: "otel", label: "UseOpenTelemetry()\nTracing", type: "process", x: COL_CENTER, y: 230 },
      { id: "host", label: "Host.Start()", type: "process", x: COL_CENTER, y: 330 },
      { id: "health", label: "Health Check\nEndpoint", type: "subprocess", x: COL_LEFT, y: 430 },
      { id: "request", label: "Incoming\nHTTP Request", type: "subprocess", x: COL_CENTER, y: 430 },
      { id: "agent", label: "Agent\nRunAsync", type: "process", x: COL_CENTER, y: 530 },
      { id: "trace", label: "Emit Trace\nSpans", type: "subprocess", x: COL_RIGHT, y: 530 },
      { id: "shutdown", label: "Graceful\nShutdown", type: "end", x: COL_LEFT, y: 530 },
    ],
    edges: [
      { from: "start", to: "di" },
      { from: "di", to: "otel" },
      { from: "otel", to: "host" },
      { from: "host", to: "health" },
      { from: "host", to: "request" },
      { from: "request", to: "agent" },
      { from: "agent", to: "trace" },
      { from: "trace", to: "request" },
      { from: "host", to: "shutdown" },
    ],
  },
};
